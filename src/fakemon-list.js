const fakemonList = {
  bambao: {
    ...
    other_info: `Bambao is one of three First Partner Pokémon available in the -- region, along with -- and <a class="basic-link" href="/dex/narwhali">Narwhali</a>.`,
    training: {
      ev_yield: { attack: 1 },
      catch_rate: 45,
  ...
  narwhali: {
    ...
    other_info: `Narwhali is one of three First Partner Pokémon available in the -- region, along with <a class="basic-link" href="/dex/bambao">Bambao</a> and --.`,
    training: {
      ev_yield: { speed: 1 },
      catch_rate: 45,
      growth_rate: 'Medium Slow'
